...
import a.jinkim.tinderapp.DBKey.Companion.DIS_LIKE
import a.jinkim.tinderapp.DBKey.Companion.LIKE
...
import a.jinkim.tinderapp.DBKey.Companion.USER_ID
...
class LikeActivity : AppCompatActivity(), CardStackListener {
    ...
    private fun disLike() {
        ...
        Toast.makeText(this, "${card.name} disLike 하셨습니다.", Toast.LENGTH_SHORT).show()
    }
    ...
    private fun like() {
        ...
        saveMatchInfoOtherUserLikedMe(card.userId)

        Toast.makeText(this, "${card.name} Like 하셨습니다.", Toast.LENGTH_SHORT).show()
    }

    private fun saveMatchInfoOtherUserLikedMe(otherUserId: String) {
        val otherUserDB = userDB.child(getCurrentUserID()) // 나의정보
            .child(LIKED_BY) // 좋아요에 대한정보
            .child(LIKE) // true 이면 날 좋아요
