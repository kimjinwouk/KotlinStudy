...
import com.kimjinwouk.petwalk.util.Constants.Companion.ACTION_PAUSE_SERVICE
...
import com.kimjinwouk.petwalk.util.Constants.Companion.FASTEST_LOCATION_UPDATE_INTERVAL
import com.kimjinwouk.petwalk.util.Constants.Companion.LOCATION_UPDATE_INTERVAL
import com.kimjinwouk.petwalk.util.Constants.Companion.NOTIFICATION_CHANNEL_ID
import com.kimjinwouk.petwalk.util.Constants.Companion.NOTIFICATION_CHANNEL_NAME
import com.kimjinwouk.petwalk.util.Constants.Companion.NOTIFICATION_ID
import com.kimjinwouk.petwalk.util.Constants.Companion.TAG
import com.kimjinwouk.petwalk.util.Constants.Companion.TIMER_UPDATE_INTERVAL
...
class PetWalkService : LifecycleService() {
    ...
    private fun updateNotificationTrackingState(isTracking: Boolean) {
        ...
        val pendingIntent = if (isTracking) {
            val pauseIntent = Intent(this, PetWalkService::class.java).apply {
            ...
            val resumeIntent = Intent(this, PetWalkService::class.java).apply {
    ...
    */
    ...
    private fun updateLocation(isTracking: Boolean) {
        if (isTracking) {
            if (PetWalkUtil.hasLocationPermissions(this)) {
        ...
        timeRunInSeconds.observe(this, Observer {
            ...
            if (!serviceKilled) {
                val notification = currentNotificationBuilder
                    .setContentText(PetWalkUtil.getFormattedStopWatchTime(it * 1000L))
